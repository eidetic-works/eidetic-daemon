...
<!-- 1-3 sentences: what + why. Avoid restating the diff. -->
...
<!--
GUIDE (delete before submitting):

`Track:` is REQUIRED — `track-tag-check` CI gate fails fast (<30s) without it. One of:
  A | B | C | Career-capital
(See PLAN.md § Determinism+autopilot § B in mcp-server-nucleus monorepo.)
